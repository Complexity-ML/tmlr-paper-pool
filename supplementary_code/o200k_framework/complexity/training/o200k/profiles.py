...
def make_config(args) -> ModelConfig:
    ...
    return ModelConfig(
        ...
        router_balance_mode=getattr(args, "router_balance_mode", "aux_loss"),
        router_aux_loss_coef=getattr(args, "router_aux_loss_coef", 0.01),
        router_bias_update_rate=getattr(args, "router_bias_update_rate", 0.001),
        ...
        routing_strategy=getattr(args, "routing_strategy", "modulo_balanced_secondary"),
