"""
Local ~300M residual Token-Routed run.

Runs on CUDA, MPS, or CPU with the same CLI/log schema as the dense local
baseline. The matched 300M scaling configuration uses a 3840-wide shared
expert, a small 256-wide routed branch, top-k=2 routing, shared/routed gate
initialization 1.0/0.1, and Mu-Guidance disabled unless explicitly enabled.
