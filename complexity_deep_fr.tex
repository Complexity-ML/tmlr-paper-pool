...
\begin{itemize}
    ...
    \item \textbf{Ablations formelles} : bien que notre analyse th\'{e}orique (Section~\ref{sec:theory}) \'{e}tablisse des propri\'{e}t\'{e}s cl\'{e}s et que l'analyse d'activit\'{e} d\'{e}montre que les composants sont utilis\'{e}s, des ablations contr\^{o}l\'{e}es sont n\'{e}cessaires pour quantifier pr\'{e}cis\'{e}ment la contribution empirique de chaque innovation
...
Les travaux futurs incluront : (1) des \'{e}tudes d'ablation formelles avec des budgets de calcul contr\^{o}l\'{e}s pour quantifier pr\'{e}cis\'{e}ment les contributions individuelles des composants, et (2) une validation rigoureuse de l'hypoth\`{e}se de d\'{e}pendance noyau \`{a} travers des exp\'{e}riences contr\^{o}l\'{e}es comparant les strat\'{e}gies d'entra\^{i}nement ancr\'{e}es sur MMLU versus uniformes \`{a} travers plusieurs domaines.
