...
\subsection{Dense Computational Substrate for Conditional Modules}

The evaluated architecture can be viewed as an instance of a broader dense-first integration pattern. Let $F_{\mathrm{dense}}$ denote a transformation applied uniformly to every token and $G_{\mathrm{conditional}}$ a structured module whose parameters or execution path depend on a discrete condition $z$:
\begin{equation}
